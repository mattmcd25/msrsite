...
const searchCards = (props) => [
    {
        ...
        icon:'person',
        children: <PropListElement edit data={props.general} onChange={props.onMemChange}/>
    },
    {
        title:'Skills',
        subtitle:'Search for members with specific skills.',
        icon:'format_paint',
        children: <ChipListElement edit list={props.skills} acData={CONSTANTS['Skill']}
    ...
    },
    {
        ...
        icon:'business',
        children: [<PropListElement edit data={props.work} onChange={props.onWorkChange}/>,
